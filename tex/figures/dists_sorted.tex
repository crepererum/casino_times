\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot [mark=x,color=kit-green2] coordinates {(16,0.0632296354112135)};
        \addplot [mark=x,color=kit-cyan] coordinates {(10,0.1994456116321715)};
        \addplot [mark=x,color=kit-red] coordinates {(9,0.1890627965205028)};
    \end{axis}
\end{tikzpicture}
