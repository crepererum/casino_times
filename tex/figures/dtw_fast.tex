\begin{tikzpicture}[
    ...
    \begin{scope}[local bounding box=grid]
        ...
        \node[cellbx] (bx8;5) at (0.4cm*8,0.4cm*5) {};
        \node[cellby] (by8;6) at (0.4cm*8,0.4cm*6) {};
    ...
    \node [left = 0.05cm of ax7;5] {\contour{white}{match}};
    \node [left = 0.05cm of ax7;6] {\contour{white}{insert}};
    \node [right = 0.05cm of bx8;5] {\contour{white}{delete}};

    \draw[mytrans] (ax7;5.center) -- (by8;6.center);
    \draw[mytrans] (ax7;6.center) -- (by8;6.center);
    \draw[mytrans] (bx8;5.center) -- (by8;6.center);

    \node [above = 1.2cm of a7;11, rotate = 90, anchor = center, kit-green2] {\contour{white}{buffer a}};
    \node [above = 1.2cm of b8;12, rotate = 90, anchor = center, kit-red] {\contour{white}{buffer b}};
\end{tikzpicture}
