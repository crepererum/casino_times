...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{r R R R R R}
        ...
        \bottomrule
    \end{tabularx}
    \caption{Total amount of \num{1}-grams after each clean-up step}\label{tab:clean_up_numbers_1}
\end{table}
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{r R R R R R}
        ...
        \bottomrule
    \end{tabularx}
    \caption{Total amount of \num{2}-grams after each clean-up step}\label{tab:clean_up_numbers_2}
\end{table}
...
\begin{sidewaysfigure}
    \centering
    \megatree{misc/tree_data1.tex}
    \caption[Example tree merges, full range nearest neighbors]{Example tree merges, nearest neighbors of \enquote{drug} in $[1,256]$ with $r=10$}\label{fig:megatree1}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}
    ...
    \caption[Example tree merges, half range nearest neighbors]{Example tree merges, nearest neighbors of \enquote{drug} in $[129,256]$ with $r=10$}\label{fig:megatree2}
\end{sidewaysfigure}
